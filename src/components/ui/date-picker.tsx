...
const DatePickerInput = (props: DatePickerPrimitive.InputProps) => {
  ...
  return (
    <DatePickerPrimitive.Input
      class={cn(
        //"h-9 w-full rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-sm transition-shadow placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-[1.5px] focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50",
  ...
  return (
    <DatePickerPrimitive.TableCell
      class={cn(
        ...
        "has-data-outside-range:rounded-md has-data-outside-range:bg-accent/50",
        "has-data-outside-range:first-of-type:rounded-l-md has-data-outside-range:last-of-type:rounded-r-md",
        local.class,
      )}
      {...others}
    />

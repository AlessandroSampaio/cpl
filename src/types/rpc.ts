...
export type IpcError = { type: "DatabaseError" } | { type: "InvalidValue"; data: [string, string] } | { type: "MigrationError"; data: string }
...
export type TankMovByDateRange = { date: string; total_collections: string; total_withdrawals: string }

export type Withdrawal = { id: number; tank_id: number; quantity: string; date: string }

const ARGS_MAP = { 'collections':'{"create_collection":["new_collection"],"delete_collection":["collection_id"],"get_collection":["collection_id"],"list_collections":[],"update_collection":["collection_id","collection"]}', 'collectors':'{"create_collector":["collector"],"delete_collector":["collector_id"],"get_collector":["collector_id"],"list_collectors":["filter"],"update_collector":["collector_id","collector"]}', 'dashboard':'{"get_collection_by_date_range":["start_date","end_date"],"get_collector_data":["start_date","end_date"],"get_producer_data":["start_date","end_date"]}', 'producers':'{"create_producer":["producer"],"delete_producer":["producer_id"],"get_producer":["producer_id"],"list_producers":["filter"],"update_producer":["producer_id","producer"]}', 'setup':'{"on_progress":["on_event"]}', 'tanks':'{"create_tank":["new_tank"],"delete_tank":["tank_id"],"get_tank":["tank_id"],"list_tanks":[],"update_tank":["tank_id","updated_tank"]}', 'withdrawals':'{"create_withdrawal":["new_withdrawal"]}' }
...
"dashboard": {get_collection_by_date_range: (startDate: string, endDate: string) => Promise<TankMovByDateRange[]>, 
get_collector_data: (startDate: string, endDate: string) => Promise<CollectionByCollector[]>, 
get_producer_data: (startDate: string, endDate: string) => Promise<CollectionByProducer[]>},
...
"setup": {on_progress: (onEvent: TAURI_CHANNEL<SetupProgress>) => Promise<null>},
